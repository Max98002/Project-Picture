...
/* harmony import */ var _modules_changeState__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/changeState */ "./src/js/modules/changeState.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  new _modules_modals__WEBPACK_IMPORTED_MODULE_0__["default"]('.button-design', '.popup-design', '.popup-design .popup-close').init();
  new _modules_modals__WEBPACK_IMPORTED_MODULE_0__["default"]('.button-consultation', '.popup-consultation', '.popup-consultation .popup-close').init();
  new _modules_modals__WEBPACK_IMPORTED_MODULE_0__["default"]('.fixed-gift', '.popup-gift', '.popup-gift .popup-close', true).init(); // new Modals().showModalByTime('.popup-consultation', 60000);

  new _modules_modals__WEBPACK_IMPORTED_MODULE_0__["default"]().openByScroll('.fixed-gift');
  ...
  var formSatet = {};
  Object(_modules_changeState__WEBPACK_IMPORTED_MODULE_7__["default"])(formSatet);
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"])(formSatet);
...
var accordion = function accordion(triggerSelector, itemsSelector) {
  var btns = document.querySelectorAll(triggerSelector),
      blocks = document.querySelectorAll(itemsSelector); // blocks.forEach(block => block.classList.add('animated', 'fadeInDown'));
  // btns.forEach(btn => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burger = function burger(btnSelector, menuSelector) {
  ...
  window.addEventListener('resize', function () {
    return window.screen.availWidth > 993 ? menu.style.display = 'none' : '';
  });
};
...
var filter = function filter() {
  ...
  function bindActionElement(menuWrapper, markWrapper, btnType, markType) {
    var menuWrap = document.querySelector(menuWrapper),
    ...
    btnTriger.forEach(function (btn) {
      btn.addEventListener('click', function () {
...
var forms = function forms(state) {
  ...
  var clearInput = function clearInput() {
    ...
    upload.forEach(function (item) {
      return item.previousElementSibling.textContent = 'Файл не вибран';
    });
  };
...
/*#__PURE__*/
function () {
  function Modals(triggerSelector, triggerModal, triggerClose) {
  ...
  _createClass(Modals, [{
    key: "showModalByTime",
    value: function showModalByTime(modalSelector, time) {
      setTimeout(function () {
        var display;
    ...
    key: "openByScroll",
    value: function openByScroll(giftSelector) {
      var _this = this;

      window.addEventListener('scroll', function () {
        if (!_this.btnPressed && window.pageYOffset + document.documentElement.clientHeight >= document.documentElement.scrollHeight) {
    ...
    value: function init() {
      ...
      this.triggers.forEach(function (trigger) {
        trigger.addEventListener('click', function (e) {
          ...
          _this2.modal.style.display = 'block';
          document.body.style.overflow = 'hidden';
        });
      });
      ...
      this.modal.addEventListener('click', function (e) {
        // логіка кліка на подложку модалки
        var target = e.target;

        if (target && target === _this2.modal) {
          // якщо всі параментри true тоді вікна закриється . не закриється якщо буде false
          _this2.modal.style.display = 'none';
          document.body.style.overflow = '';
        }
      });
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Could not fetch ".concat(urk, ", status: ").concat(res.status));
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResouce"])('http://localhost:3000/styles').then(function (res) {
...
var slider = function slider(_slider) {
  ...
  var slideIndex = 1,
      paused = false;
  var slides = document.querySelectorAll(_slider);
  ...
  function showSlides(n) {
    ...
    slides.forEach(function (slid) {
      ...
      slid.addEventListener('mouseover', function () {});
    });
